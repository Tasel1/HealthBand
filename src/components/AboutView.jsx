    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-6">
        ...
        <p className="text-sm text-slate-300 mt-2 max-w-3xl leading-relaxed">
          Научно-клиническое досье инженерного решения для отделений гнойной хирургии, комбустиологии и гериатрического ухода. Система решает фундаментальное противоречие современной хирургии: необходимость раннего выявления септического очага без механической травматизации молодого грануляционного слоя частыми ревизиями повязки.
        </p>

        <div className="mt-4 pt-4 border-t border-slate-800 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-slate-300">
          <div>
            <span className="text-slate-500 uppercase tracking-wider text-[10px] block font-semibold">Клинический эффект</span>
            <span className="font-semibold text-white mt-0.5 block">Детекция на 10–14 часов раньше</span>
            <span className="text-slate-400">Предупреждение флегмоны и сепсиса до системного ответа</span>
          </div>
          <div>
            <span className="text-slate-500 uppercase tracking-wider text-[10px] block font-semibold">Снижение травматизации</span>
            <span className="font-semibold text-white mt-0.5 block">На 40% меньше перевязок</span>
            <span className="text-slate-400">Сохранение краевой эпителизации и влажной среды заживления</span>
          </div>
          <div>
            <span className="text-slate-500 uppercase tracking-wider text-[10px] block font-semibold">Экономическая доступность</span>
            <span className="font-semibold text-white mt-0.5 block">26 000 ₸ (~$55) за комплект</span>
            <span className="text-slate-400">Многоразовый электронный блок со сменными датчиками</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 space-y-4">
        <div className="border-b border-slate-800 pb-2.5">
          <h2 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
            ...
            Аппаратная архитектура: 4 измерительных канала сенсорной матрицы
          </h2>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 space-y-3">
        <h2 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
          ...
          Энергопотребление прошивки: Алгоритм Deep Sleep (95% сон / 5% бодрствование)
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 text-xs">
          <div className="bg-slate-950 p-3 rounded border border-slate-800">
            <span className="text-slate-400 text-[10px] block uppercase font-mono">Фаза 1: Сон</span>
          ...
          <div className="bg-slate-950 p-3 rounded border border-slate-800">
            <span className="text-slate-400 text-[10px] block uppercase font-mono">Фаза 2: Опрос</span>
          ...
          <div className="bg-slate-950 p-3 rounded border border-slate-800">
            <span className="text-slate-400 text-[10px] block uppercase font-mono">Фаза 3: Расчет</span>
          ...
          <div className="bg-slate-950 p-3 rounded border border-slate-800">
            <span className="text-slate-400 text-[10px] block uppercase font-mono">Фаза 4: Передача</span>
          ...
          <table className="w-full text-xs text-left border border-slate-800 rounded overflow-hidden">
            <thead className="bg-slate-950 text-slate-400 border-b border-slate-800 text-[11px] uppercase tracking-wider">
              <tr>
                ...
                <th className="py-2.5 px-3 w-3/8 text-cyan-300 bg-cyan-950/20 border-r border-slate-800">
                  HealthBand (Наше инженерное решение)
                </th>
                <th className="py-2.5 px-3 w-3/8 text-slate-400">
            ...
            <tbody className="divide-y divide-slate-800 text-slate-300">
              <tr>
                ...
                <td className="py-3 px-3 bg-cyan-950/10 border-r border-slate-800">
              ...
              <tr>
                ...
                <td className="py-3 px-3 bg-cyan-950/10 border-r border-slate-800">
                  <span className="font-semibold text-slate-200">Ранняя диагностика & своевременная замена повязки</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
                    Пассивный сбор данных без инвазивных вмешательств в раневой гомеостаз
                  </p>
                </td>
                <td className="py-3 px-3">
                  <span className="text-slate-300">Активная электростимуляция током</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
              ...
              <tr>
                ...
                <td className="py-3 px-3">
                  <span className="text-slate-300">Индивидуальный радиосчитыватель</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
              ...
              <tr>
                ...
                <td className="py-3 px-3">
                  <span className="text-slate-300">Прямой замер импеданса</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
              ...
              <tr>
                ...
                <td className="py-3 px-3 bg-cyan-950/10 border-r border-slate-800">
                  <span className="font-semibold text-slate-200">Любые стандартные повязки</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
                    Сенсор помещается в стерильный промежуточный карман бинта/пластыря
                  </p>
                </td>
                <td className="py-3 px-3">
                  <span className="text-slate-300">Уникальный проприетарный пластырь</span>
                  <p className="text-[11px] text-slate-400 mt-0.5">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 space-y-4">
        <h2 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
          ...
          Инженерно-медицинские ответы на ключевые вопросы экспертной комиссии
        </h2>
